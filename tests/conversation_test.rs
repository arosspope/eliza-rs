...
fn convo_textbook(){
    ...
    assert_eq!("Your boyfriend made you come here?", e.respond("Well, my boyfriend made me come here."));
    assert_eq!("I am sorry to hear you are depressed.", e.respond("He says I'm depressed much of the time."));
    assert_eq!("Do you think coming here will help you not to be unhappy?", e.respond("It's true. I am unhappy."));
    assert_eq!("What would it mean to you if you got some help?", e.respond("I need some help, that much seems certain."));
    assert_eq!("Tell me more about your family.", e.respond("Perhaps I could learn to get along with my mother."));
    assert_eq!("Who else in your family takes care of you?", e.respond("My mother takes care of me."));
